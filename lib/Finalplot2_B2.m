...
hha=tight_subplot(2,2,[0.03 0.05 ],[0.1 0.1 ],[0.1 0.15])
...
%h=legend('forearc residual','backarc residual','forearc median','backarc median');
set(h,'Position',rect)
set(hha,'ytick',[-3,-2,-1,0,1,2,3])
set(hha,'xtick',[10  100 1000])

set(hha(1:2),'XTickLabel','')
set(hha([2,4]),'YTickLabel','')
%set(hha([2]),'YTickLabel','')
set(gcf,'color','white','paperpositionmode','auto');
figname=strcat(project_ad,'Fig/final2B2.png');
